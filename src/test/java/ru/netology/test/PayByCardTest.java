...
//    @Test
//    void fff() {
//        var choiceOfPaymentVariantPage = open("http://localhost:8080/", ChoiceOfPaymentVariantPage.class);
...
//    }
    ...
    @Test
    void declinedPayment() { //падает, сделать issue
        var choiceOfPaymentVariantPage = open("http://localhost:8080/",
                ChoiceOfPaymentVariantPage.class);
        choiceOfPaymentVariantPage.payByCard();
        PaymentPage make = new PaymentPage();
    ...
    @Test
    void cardOwnerPlusSpecSymbol() { //падает, сделать issue
        var choiceOfPaymentVariantPage = open("http://localhost:8080/",
                ChoiceOfPaymentVariantPage.class);
        choiceOfPaymentVariantPage.payByCard();
        PaymentPage make = new PaymentPage();
    ...
    @Test
    void cardOwnerPlusNumber() { //падает, сделать issue
        var choiceOfPaymentVariantPage = open("http://localhost:8080/",
                ChoiceOfPaymentVariantPage.class);
        choiceOfPaymentVariantPage.payByCard();
        PaymentPage make = new PaymentPage();
    ...
    @Test
    void cardOwnerByRus() { //падает, сделать issue
        var choiceOfPaymentVariantPage = open("http://localhost:8080/",
                ChoiceOfPaymentVariantPage.class);
        choiceOfPaymentVariantPage.payByCard();
        PaymentPage make = new PaymentPage();
    ...
    @Test
    void emptyCvcCode() { //падает, сделать issue
        var choiceOfPaymentVariantPage = open("http://localhost:8080/",
                ChoiceOfPaymentVariantPage.class);
        choiceOfPaymentVariantPage.payByCard();
        PaymentPage make = new PaymentPage();
